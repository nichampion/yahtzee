...
int main(int argc, char** argv)
{
	...
	SDL_Window *pWindow = NULL;
  	...
  	SDL_Surface *j_courant=NULL, *msg=NULL, *tab_score=NULL, *de_courant=NULL, *de1=NULL, *de2=NULL, *de3=NULL, *de4=NULL, *de5=NULL, *de6=NULL, *img_btn_lancer=NULL, *img_btn_tour=NULL, *caseJ=NULL;
  ...
  if (SDL_Init(SDL_INIT_VIDEO) != 0 ) {
	...
	SDL_RWops *rwop_btn_tour=SDL_RWFromFile("img/btn_tour.png", "rb");
	img_btn_tour=IMG_LoadPNG_RW(rwop_btn_tour);
	if(!img_btn_tour) {
		printf("IMG_LoadPNG_RW: %s\n", IMG_GetError());
	}
	...
	SDL_Texture *btn_tour_tex = SDL_CreateTextureFromSurface(renderer, img_btn_tour);
	if(!btn_tour_tex){
		fprintf(stderr, "Erreur à la création du rendu de l'image : %s\n", SDL_GetError());
		exit(EXIT_FAILURE);
	}
					...
					case SDL_WINDOWEVENT:
						switch(e.window.event){
							case SDL_WINDOWEVENT_SHOWN:
								...
								SDL_QueryTexture(btn_tour_tex, NULL, NULL, &(imgDestRect.w), &(imgDestRect.h));
								SDL_RenderCopy(renderer, btn_tour_tex, NULL, &imgDestRect);
